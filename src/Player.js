Player = function(x, y){
	...
	this.exp = 0;
	this.expForLevels = [0, 10, 25, 50, 75, 100, 125, 150, 200, 250, 300, 350, 450, 600, 750,
	 900, 1100, 1300, 1500, 1750, 2000, 2500, 3000, 3250, 3500, 3750, 4000,
	 4250, 4500, 4750, 5000, 5250, 5500, 5750, 6000, 6250, 6500, 6750, 7000, 7250, 7500, 7750,
	  8000, 9000, 10000, 11000, 12000, 13000, 14000, 15000, 16000, 17000, 18000, 19000, 20000, 25000, 50000, 100000, 100000000000];
	this.level = 0;
	this.comboCount = 0;
